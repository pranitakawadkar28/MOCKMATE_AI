...
const Step3Report = ({ report }) => {
  ...
  const downloadPDF = () => { 
    ...
    doc.save("MockMate_AI_Report.pdf");
  }; 
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-blue-50 px-4 sm:px-6 lg:px-10 py-8">
      ...
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          onClick={downloadPDF}
          className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base whitespace-nowrap"
        >
          Download PDF
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        <div className="space-y-6">
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-500 mt-1 text-sm">{shortTagline}</p>
            </div>
          </motion.div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          >
            ...
            <div className="h-64 sm:h-72 style={{ minHeight: 0 }}">
